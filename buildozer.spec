...
source.include_exts = py,png,jpg,kv,atlas,html,css,js,mp3,wav,jar,ttf
...
requirements = python3, flask, pywebview, sympy, mpmath, jinja2, werkzeug, itsdangerous, click, proxy_tools, bottle, typing_extensions, android, pyjnius
...
icon.adaptive_foreground.filename = %(source.dir)s/icon-foreground.png
icon.adaptive_background.filename = %(source.dir)s/icon-background.png
